...
def knn_monitor(net, memory_data_loader, test_data_loader, gpu, k=200, t=0.1, hide_progress=False):
    net.eval()
...
#             print('###1second:',endtime-starttime)            
            feature = net(data.cuda(gpu, non_blocking=True))
